<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RentPage.aspx.cs" Inherits="InHouseProjectFinal.RentPage" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" BackColor="#0066FF" CssClass="roundedcorners" Font-Bold="True" Font-Size="32px" ForeColor="White" Height="55px" Text="Search" Width="150px" style="background: linear-gradient(to right,purple , deeppink );" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <br /><br /><br /><br /><br /><br /><br /> -->
       ...
       <!--Code For Recently added houses 
            ...
            <div class="main">
        <div class="wrapper">
            <center><h3>Properties for Rent</h3></center>
            <br>
            ...
            <div class="clearfix">
                  ...
                  <div class="houses">
                    ...
                    <a href="book.html">
                        <asp:Button ID="Button2" runat="server" cssClass="btn-book" text="VIEW DETAILS" OnClick="rentbtn0_Click" />
                    </a>
                </div>
        ...
        <br /><br />
            <div class="main">
        <div class="wrapper">
            <center><h3>PG Services</h3></center>
            <br>
            <!--Displaying Recently Added Houses in Boxes-->
            <div class="clearfix">
                ...
                <div class="houses">
                    ...
                    <span style="color:blue;text-align:center;">₹ 5800</span><br />
                    <span class="house-location">Location: Jagatpur, Jaipur</span><br />
                    <a href="book.html">
                         <asp:Button ID="pgbtn1" runat="server" cssClass="btn-book" text="VIEW DETAILS" OnClick="pgbtn1_Click" />
                    </a>
                </div>
                ...
                <div class="houses">
                    ...
                    <span style="color:blue;text-align:center;">₹ 3800</span><br />
                    <span class="house-location">Location: VaishaliNagar, Jaipur</span><br />
                    <asp:Button ID="pgbtn2" runat="server" cssClass="btn-book" text="VIEW DETAILS" OnClick="pgbtn2_Click" />
                </div>

                <div class="houses">
                    <img src="Images/pg2.jpg" />
                    
                    <span style="color:blue;text-align:center;">₹ 2880</span><br />
                    <span class="house-location">Location: RamNagar, Jaipur</span><br />
                    <asp:Button ID="pgbtn3" runat="server" cssClass="btn-book" text="VIEW DETAILS" OnClick="pgbtn3_Click" />
                </div>

                <div class="houses">
                    <img src="Images/pg3.jpg" />
                    
                    <span style="color:blue;text-align:center;">₹ 4200</span><br />
                    <span class="house-location">Location: Sanganer, Jaipur</span><br />
                    <asp:Button ID="pgbtn4" runat="server" cssClass="btn-book" text="VIEW DETAILS" OnClick="pgbtn4_Click" />
                </div>

                <div class="houses">
                    <img src="Images/pg4.jpg" />
                    
                    <span style="color:blue;text-align:center;">₹ 3700</span><br />
                    <span class="house-location">Location: Sitapura, Jaipur</span><br />
                    <asp:Button ID="pgbtn5" runat="server" cssClass="btn-book" text="VIEW DETAILS" OnClick="pgbtn5_Click" />
                </div>

                <div class="houses">
                    <img src="Images/pg5.jpg" />
                    
                    <span style="color:blue;text-align:center;">₹ 4500</span><br />
                    <span class="house-location">Location: Malviyanagar, Jaipur</span><br />
                    <asp:Button ID="pgbtn6" runat="server" cssClass="btn-book" text="VIEW DETAILS" OnClick="pgbtn6_Click" />
                </div>

                <div class="houses">
                    <img src="Images/pg6.jpg" />
                    
                    <span style="color:blue;text-align:center;">₹ 4200</span><br />
                    <span class="house-location">Location: Civil Lines, Jaipur</span><br />
                    <asp:Button ID="pgbtn7" runat="server" cssClass="btn-book" text="VIEW DETAILS" OnClick="pgbtn7_Click" />
                </div>

                <div class="houses">
                    <img src="Images/pg7.jpg" />
                    
                    <span style="color:blue;text-align:center;">₹ 4600</span><br />
                    <span class="house-location">Location: Kalwar, Jaipur</span><br />
                    <asp:Button ID="pgbtn8" runat="server" cssClass="btn-book" text="VIEW DETAILS" OnClick="pgbtn8_Click" />
                </div>

                <div class="houses">
                    <img src="Images/pg8.jpg" />
                    
                    <span style="color:blue;text-align:center;">₹ 4400</span><br />
                    <span class="house-location">Location:Mansarovar, Jaipur</span><br />
                    <asp:Button ID="pgbtn9" runat="server" cssClass="btn-book" text="VIEW DETAILS" OnClick="pgbtn9_Click" />
                </div>

                <div class="houses">
                    <img src="Images/pg9.jpg" />
                    
                    <span style="color:blue;text-align:center;">₹ 4800</span><br />
                    <span class="house-location">Location:C-Scheme, Jaipur</span><br />
                    <asp:Button ID="pgbtn10" runat="server" cssClass="btn-book" text="VIEW DETAILS" OnClick="pgbtn10_Click" />
                </div>
